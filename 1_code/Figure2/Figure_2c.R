...
gut_result<-select_significant_metabolites(gut_temp_object@expression_data,metabolome = metabolomics_temp_object@expression_data)
oral_result<-select_significant_metabolites(oral_temp_object@expression_data,metabolome = metabolomics_temp_object@expression_data)
skin_result<-select_significant_metabolites(skin_temp_object@expression_data,metabolome = metabolomics_temp_object@expression_data)
nasal_result<-select_significant_metabolites(nasal_temp_object@expression_data,metabolome = metabolomics_temp_object@expression_data)
