...
dir.create("3_data_analysis/gut_microbiome/Lasso/cross_section/",recursive = TRUE)

setwd("3_data_analysis/gut_microbiome/Lasso/cross_section/")
...
saveRDS(results,"gut_lasso_results")