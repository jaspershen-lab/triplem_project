...
dir.create("3_data_analysis/nasal_microbiome/Lasso/cross_section/",recursive = TRUE)

setwd("3_data_analysis/nasal_microbiome/Lasso/cross_section/")
...
saveRDS(results,"nasal_lasso_results")