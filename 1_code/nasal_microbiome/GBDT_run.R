...
dir.create("3_data_analysis/nasal_microbiome/GBDT/cross_section/",recursive = TRUE)

setwd("3_data_analysis/nasal_microbiome/GBDT/cross_section/")
...
saveRDS(results,"nasal_GBDT_results")