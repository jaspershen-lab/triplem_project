...
dir.create("3_data_analysis/oral_microbiome/Lasso/cross_section/",recursive = TRUE)

setwd("3_data_analysis/oral_microbiome/Lasso/cross_section/")
...
saveRDS(results,"oral_lasso_results")